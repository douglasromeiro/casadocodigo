...
public class CalendarConverters implements Converter {
	
	private DateTimeConverter converter = new DateTimeConverter();

	public CalendarConverters(DateTimeConverter converter) {
		converter.setPattern("dd/MM/yyyy");
		converter.setTimeZone(TimeZone.getTimeZone("America/Sao_Paulo"));
	}

	@Override
	public Object getAsObject(FacesContext context, UIComponent component, String dataObject) {
		
		Date date = (Date) converter.getAsObject(context, component, dataObject);
